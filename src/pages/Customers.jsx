...
export default function Customers() {
  ...
  const handleSubmit = (e) => {
    ...
    updateMutation.mutate({ id: editCustomer._id, data: buildPayload() })
  }
  ...
  return (
    <div className="space-y-4">
      <DataTable columns={columns} data={customers} emptyMessage="No customers yet. Convert a lead to add one." />
